...
file_mapping_master <- file_mapping_master %>%
  mutate(
    ...
    archivo_salida  = paste0("data/controles_results/events study/", type, "/", folder, 
                             "/events_study_lindo_", regType, type, "_0_", crime, ".png")
  )
...
comparison_mapping <- grid_comparacion %>%
  ...
  mutate(
    ...
    ruta_grafico_out = paste0("data/controles_results/events study/events_study_comparado_", folder, "_0_", crime, ".png")
  )
